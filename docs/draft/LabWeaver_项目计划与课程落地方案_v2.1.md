...
2. USTC Vlab 文档：<https://github.com/USTC-vlab/docs>
...
7. KubeVirt：<https://kubevirt.io/user-guide/architecture/>
8. Cyaron：<https://github.com/luogu-dev/cyaron>
9. Ansible：<https://docs.ansible.com/ansible/latest/>
10. Ansible Runner：<https://docs.ansible.com/projects/runner/en/latest/>
11. BuildKit：<https://github.com/moby/buildkit>
12. cloud-init：<https://docs.cloud-init.io/en/latest/>
13. Packer：<https://developer.hashicorp.com/packer/docs>
14. NATS JetStream：<https://docs.nats.io/nats-concepts/jetstream>
15. Keycloak OIDC：<https://www.keycloak.org/securing-apps/oidc-layers>
16. Kyverno：<https://kyverno.io/docs/>
17. Kueue：<https://kueue.sigs.k8s.io/docs/overview/>
18. Cluster API：<https://cluster-api.sigs.k8s.io/>
19. Kubernetes Node Autoscaling：<https://kubernetes.io/docs/concepts/cluster-administration/node-autoscaling/>
20. Headscale：<https://headscale.net/stable/>
21. Headscale OIDC：<https://headscale.net/stable/ref/oidc/>
22. Tailscale Policy Syntax：<https://tailscale.com/docs/reference/syntax/policy-file>
23. Playwright Test：<https://playwright.dev/docs/intro>
24. Playwright Projects：<https://playwright.dev/docs/test-projects>
