...
| KubeVirt noVNC console (#124) | same capability/session foundation with service-side VMI `/vnc` adapter | guest password/public endpoint, stale fence, stream limit, revoke/expiry and VMI stop/delete | planned; #124 implementation and #126 connected evidence required |
