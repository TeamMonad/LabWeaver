...
| --- | --- | --- | --- | --- | --- |
| Rust Workspace and foundation crates | A | planned, pending PR #21 | implementation and E1 validation exist only on PR #21 head | E0 | absent from this commit; no business domain implementation |
| Six Axum service shells | A | planned, pending PR #21 | health-route and configuration-failure validation exist only on PR #21 head | E0 | absent from this commit; no persistence, messaging or providers |
