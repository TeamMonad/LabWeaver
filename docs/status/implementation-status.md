...
| Private Sigstore trust plane (#61) | D, requires A+B security review | repository implementation in progress; real environment blocked | version/digest lock, generated Rust contracts, negative tests, allowlisted ansible-rs playbook and deployment documentation | E1 after local/CI gates | no Keycloak workload client, C0 root ceremony, router deploy/idempotency, signing, SCT/Rekor proof, restore/rotation, Kyverno or Release Gate runtime evidence |
