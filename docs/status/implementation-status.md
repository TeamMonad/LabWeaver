...
| PostgreSQL schema ownership and Migration policy | A | documented, pending A/B review | ADR 0002, data ownership and Migration contract | E0 | no SQLx, database roles, Migration files/Job, Outbox, audit projection or readiness validation |
